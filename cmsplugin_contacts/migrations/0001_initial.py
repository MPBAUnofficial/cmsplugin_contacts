...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_contacts', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('cmsplugin_contacts', ['Contacts'])

        # Adding model 'Person'
        db.create_table('cmsplugin_contacts_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_contacts.Contacts'])),
        ...
        db.send_create_signal('cmsplugin_contacts', ['Person'])


    def backwards(self, orm):
        # Deleting model 'Contacts'
        db.delete_table('cmsplugin_contacts')

        # Deleting model 'Person'
        db.delete_table('cmsplugin_contacts_person')
    ...
    models = {
        ...
        'cmsplugin_contacts.contacts': {
            'Meta': {'object_name': 'Contacts', 'db_table': "'cmsplugin_contacts'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'})
        },
        'cmsplugin_contacts.person': {
            'Meta': {'object_name': 'Person'},
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cmsplugin_contacts.Contacts']"}),
    ...
    complete_apps = ['cmsplugin_contacts']